 ...
 *
 * @class H5P.CurrikiInteractiveVideo
 ...
 *
 * @param {number} index
 * @returns {H5P.CurrikiInteractiveVideoInteraction}
 */
 ...
 *
 * @param {H5P.CurrikiInteractiveVideoInteraction[]} requiredInteractions
 ...
 *
 * @return {H5P.CurrikiInteractiveVideoInteraction[]} visible interactions
 */
